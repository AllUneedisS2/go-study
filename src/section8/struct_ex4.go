...
func main() {
	...
	fmt.Println("Employee 1 Total Compensation:", ep1.Calculate())
	fmt.Println("Employee 2 Total Compensation:", ep2.Calculate())
	...
	fmt.Println("Executive Total Compensation (Overridden):", ex.Calculate())
}
